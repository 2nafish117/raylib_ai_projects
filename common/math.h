...
namespace math {
	...
	constexpr f32 SQRT_ONE_OVER_THREE = 0.57735026918962576450f;
	 ...
	 * @param vector_0 The first vector.
	 * @param vector_1 The second vector.
	 * @param tolerance The difference tolerance. Typically J_FLOAT_EPSILON or similar.
